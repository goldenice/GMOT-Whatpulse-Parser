...
echo '<!DOCTYPE html>
	<html>
	<head>
	<title>GMOT WP STATS</title><link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen"><link href="http://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet" type="text/css"><link href="style.css" rel="stylesheet" type="text/css"></head><body><div id="container">';
...
echo ' <td><strong>Keys</strong></td><td></td><td><strong>Kliks</strong></td><td></td>';
//echo '[td][b]Keys[/td][td][/td][td][b]Kliks[/td][td][/td]';
echo ' <td><strong>' . $thirdStatHeading . '</strong></td><td></td></tr>';
...
foreach ($users as $user) {
    ...
    if ($user->getRawData('status') == 'returned') {
		echo '<abbr title="The prodigal son has returned!"><span class="green">' ;
        //echo '[abbr=The prodigal son has returned!][green]';
    }
    
    //echo $user->getUsername() . '[/td]';
    echo $user->getUsername() . '</abbr></td>';
...
echo '<script src="http://code.jquery.com/jquery-latest.js"></script>
    <script src="bootstrap/js/bootstrap.min.js"></script></div></body></html>';